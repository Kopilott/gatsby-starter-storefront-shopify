...
module.exports = {
  ...
  siteMetadata: {
    ...
    gatsbyStorefrontConfig: {
      storeName: 'Cuadros Shop',
      storeDescription: 'Tienda de Cuadros Decorativos',
      email: 'info@cuadros.shop',
      company: 'Cuadros Shop Inc.',
      location: 'Montevideo, UY',
      address: 'paysandú 941.',
      phone: '+598 (0)96 194 376',
      workingDays: 'Lunes - Viernes',
      workingHours: '09h - 19h',
      socialNetworks: [
        'https://facebook.com',
        'https://instagram.com',
        'https://pinterest.com',
